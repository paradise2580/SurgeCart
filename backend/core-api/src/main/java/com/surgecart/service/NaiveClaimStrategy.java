 ...
 * half of the project's story: read stock, check it in application code,
...
public class NaiveClaimStrategy implements ClaimStrategy {
    ...
    public ClaimOutcome claimOne(Long saleId) {
        ...
        // Saving the entity would trip its @Version check and quietly turn
        // this into optimistic locking, so write the stale value back directly.
        repository.overwriteSoldCount(saleId, sale.getSoldCount() + 1);
